...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub_imu = n.subscribe("/corrected", 30, &ImuGrabber::GrabImu, &imugb);
  ros::Subscriber sub_img0 = n.subscribe("/usb_cam/image_raw", 30, &ImageGrabber::GrabImage,&igb);
